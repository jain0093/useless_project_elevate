...
const clips6 = getClips('-30dB', 0.6);
const clips7 = getClips('-30dB', 0.7);
console.log(`d=0.6: ${clips6.length} clips`);
console.log(`d=0.7: ${clips7.length} clips`);
